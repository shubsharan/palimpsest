...
- [ ] T008 [P] Establish condition-defined peer visibility, agent-visible inputs, aggregate checker disclosure, and host-safety boundaries
...
- [ ] T012 [P] [US1] Contract/property test for [contract or invariant] in [path]
- [ ] T013 [P] [US1] Integration/isolation test for [user journey or boundary] in [path]
...
- [ ] T020 [P] [US2] Contract/property test for [contract or invariant] in [path]
- [ ] T021 [P] [US2] Integration/isolation test for [user journey or boundary] in [path]
...
- [ ] T026 [P] [US3] Contract/property test for [contract or invariant] in [path]
- [ ] T027 [P] [US3] Integration/isolation test for [user journey or boundary] in [path]
...
- [ ] TXXX [P] Complete required asynchronous lifecycle, communication-isolation, checker, Git, cutoff, and scoring verification
...
- Verification tests MUST be written and FAIL before implementation
...
Task: "Contract/property test for [contract or invariant] in [path]"
Task: "Integration/isolation test for [user journey or boundary] in [path]"
